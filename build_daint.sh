...
nvcc -c -o diamond_stencil.o diamond_stencil.cu -std=c++14 -arch=sm_60 -Xptxas -v,-abi=no -I$atlasInc -I$eckitInc -L$atlasLib -latlas -L$eckitLib -leckit -I$atlasUtilsInc
